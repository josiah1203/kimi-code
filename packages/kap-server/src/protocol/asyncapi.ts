...
const DEFAULT_TITLE = 'SpiderByte WebSocket API';
const DEFAULT_VERSION = '0.1.0';
const DEFAULT_SERVER_HOST = 'localhost';
const DEFAULT_WS_PATH = '/api/v1/ws';
const CHANNEL_ID = 'spiderbyteWebSocket';
...
export function createAsyncApiDocument(
  ...
  return {
    ...
    info: {
      ...
      version,
      description:
        'WebSocket protocol for SpiderByte daemon control frames, acknowledgements, system frames, and session event streaming.',
    },
    ...
    servers: {
      local: {
        ...
        pathname: wsPath,
        description: 'SpiderByte daemon WebSocket endpoint.',
      },
    },
    channels: {
      [CHANNEL_ID]: {
