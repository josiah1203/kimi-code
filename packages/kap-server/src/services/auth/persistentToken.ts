 ...
 *
 * The token lives at `<SPIDERBYTE_HOME>/server.token` (mode 0600) and is reused
 ...
 * `spyderbyte web rotate-token` (which calls {@link rotateServerToken}).
 *
...
/** On-disk filename for the persistent token, relative to SPIDERBYTE_HOME. */
