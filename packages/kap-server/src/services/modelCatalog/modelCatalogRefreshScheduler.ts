 ...
 * `SPIDERBYTE_MODEL_CATALOG_REFRESH_INTERVAL_MS` /
 * `SPIDERBYTE_MODEL_CATALOG_REFRESH_ON_START` env vars as overrides (matching
...
const INTERVAL_ENV = 'SPIDERBYTE_MODEL_CATALOG_REFRESH_INTERVAL_MS';
const REFRESH_ON_START_ENV = 'SPIDERBYTE_MODEL_CATALOG_REFRESH_ON_START';
