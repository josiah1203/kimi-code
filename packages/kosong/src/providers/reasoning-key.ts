 ...
 *
 * - `reasoning_content` — DeepSeek's original convention, used by the upstream provider
 *   external provider API, pre-rename vLLM, and most OpenAI-compatible gateways.
