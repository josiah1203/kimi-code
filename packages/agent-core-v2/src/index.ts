...
export * from '#/app/platformIdentity/platformIdentity';
export * from '#/app/platformIdentity/errors';
import '#/app/platformIdentity/platformIdentityService';
...
export * from '#/workspace/commercial/commercial';
import '#/workspace/commercial/commercialService';
