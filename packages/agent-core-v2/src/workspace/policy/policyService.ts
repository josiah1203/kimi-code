...
const defaultRules: readonly PolicyRule[] = [
  { capability: 'shell', effect: 'allow', reason: 'local shell actions are governed by Kimi tool policy' },
  { capability: 'filesystem', effect: 'allow', reason: 'local filesystem actions are governed by Kimi tool policy' },
