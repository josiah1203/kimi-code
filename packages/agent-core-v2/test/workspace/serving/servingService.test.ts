...
const context: WorkspaceContext = {
  ...
  workspaceId: 'wd_kimi_serving_0123456789ab',
  cwd: '/tmp/kimi-serving',
  source: 'local',
  meta: { id: 'wd_kimi_serving_0123456789ab', root: '/tmp/kimi-serving', name: 'serving', createdAt: Date.now(), lastOpenedAt: Date.now() },
  persistenceScope: 'workspaces/wd_kimi_serving_0123456789ab',
  osBackendId: 'local',
