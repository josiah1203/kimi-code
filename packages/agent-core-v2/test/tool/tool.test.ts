Warning: truncated output (original token count: 61400)
  ...
  describe('failed Bash hook flow', () => {
    ...
    it('persists oversized registered user tool results before adding them to context', async () => {
      ...
      expect(outputPath).toContain(
        join(homeDir, 'sessions/wd_test_0123456789ab/test-session/agents/main/tool-results/Lookup-call_lookup-'),
      );
