 ...
 * subset of `SpiderByte Agent Core/agent/rpc/core-api.ts`; every method takes one
 ...
 * (text / image_url / video_url) from `SpiderByte Agent Core/kosong/contract/message.ts`.
...
/** `AgentCommandInfo` (`SpiderByte Agent Core/agent/command/agentCommand.ts`). */
