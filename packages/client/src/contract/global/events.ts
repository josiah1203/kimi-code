...
import type { ConfigChangedEvent } from '@spiderbyte/agent-core/app/config/config';
import type { ModelsChangedEvent } from '@spiderbyte/agent-core/kosong/model/model';
import type { ProvidersChangedEvent } from '@spiderbyte/agent-core/kosong/provider/provider';
import type { ReloadSummary } from '@spiderbyte/agent-core/app/plugin/types';
import type { RefreshProviderModelsResponse } from '@spiderbyte/agent-core/app/kosongConfig/discovery';
...
/** Payload of `event.model_catalog.changed` — local provider metadata refresh. */
export type CatalogChangedPayload = RefreshProviderModelsResponse;
