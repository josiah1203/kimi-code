 ...
 *
 * Wire shapes the engine imports from `@spiderbyte/protocol` are reached
...
import type {
  ...
  ToolCallRef,
  TurnPhase,
} from '@spiderbyte/agent-core/agent/activityView/activityView';
...
import type { PlanData } from '@spiderbyte/agent-core/features/plan/plan';
import type {
  ...
  ShellCommandResult,
  StopTaskPayload,
} from '@spiderbyte/agent-core/agent/rpc/core-api';
...
import type { McpServerEntry } from '@spiderbyte/agent-core/mcpCore/connection-manager';
import type { FullCompactionInput } from '@spiderbyte/agent-core/agent/fullCompaction/fullCompaction';
import type { ISessionScopeHandle } from '@spiderbyte/agent-core/_base/di/scope';
import type {
  CreateChildSessionOptions,
  CreateSessionOptions,
  ForkSessionOptions,
  ResumeSessionOptions,
} from '@spiderbyte/agent-core/workspace/sessionLifecycle/sessionLifecycle';
import type {
  ApprovalRequest,
  ApprovalResponse,
...
import type { IBootstrapService } from '@spiderbyte/agent-core/app/bootstrap/bootstrap';
import type {
  ConfigDiagnostic,
  ConfigInspectValue,
  ConfigTarget,
...
import type { ModelRecord } from '@spiderbyte/agent-core/kosong/model/model';
import type { IModelCatalog } from '@spiderbyte/agent-core/kosong/model/catalog';
import type { IProviderDiscoveryService } from '@spiderbyte/agent-core/app/kosongConfig/discovery';
import type {
  GetPluginInfoInput,
  InstallPluginInput,
  RemovePluginInput,
...
} from '@spiderbyte/agent-core/app/plugin/plugin';
import type {
  PluginCommandDef,
  PluginDiagnostic,
...
import type { ProviderConfig } from '@spiderbyte/agent-core/kosong/provider/provider';
import type {
  SessionListQuery,
  SessionSummary,
...
// Test-only: `@spiderbyte/protocol` is a devDependency; importing its types
