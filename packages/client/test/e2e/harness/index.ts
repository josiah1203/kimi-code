/**
 * `@spiderbyte/server-e2e` — wire-level test client for the spiderbyte server.
 *
 ...
 *
 * Re-exports `@spiderbyte/protocol` types are NOT bundled here — scenarios
 * that want them import from `@spiderbyte/protocol` directly.
 */
