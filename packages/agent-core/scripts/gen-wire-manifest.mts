 ...
 *
 * Usage:
 *   pnpm --filter @spiderbyte/agent-core gen:wire-manifest          # write the file
 *   pnpm --filter @spiderbyte/agent-core gen:wire-manifest --check  # freshness check (CI-style)
 *
...
export async function buildWireManifest(): Promise<string> {
  ...
  const out: string[] = [
    ...
    '// Regenerate with: pnpm --filter @spiderbyte/agent-core gen:wire-manifest',
    '//',
