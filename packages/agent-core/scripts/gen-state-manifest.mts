 ...
 *
 * Usage:
 *   pnpm --filter @spiderbyte/agent-core gen:state-manifest          # write the file
 *   pnpm --filter @spiderbyte/agent-core gen:state-manifest --check  # freshness check (CI-style)
 *
...
function renderManifest(
  ...
  const out: string[] = [
    ...
    '// Regenerate with: pnpm --filter @spiderbyte/agent-core gen:state-manifest',
    '//',
