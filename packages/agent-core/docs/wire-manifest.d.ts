...
//   platform.model.cleared             platform.modelBinding  persisted  src/agent/platformModelBinding/platformModelBindingOps.ts
//   platform.model.selected            platform.modelBinding  persisted  src/agent/platformModelBinding/platformModelBindingOps.ts
...
/**
 * model: platform.modelBinding · persisted
 * owner: src/agent/platformModelBinding/platformModelBindingOps.ts
 */
interface PlatformModelClearedPayload {
  _name: 'platform.model.cleared';
}
 ...
 * owner: src/agent/platformModelBinding/platformModelBindingOps.ts
 */
interface PlatformModelSelectedPayload {
  _name: 'platform.model.selected';
  model_ref: {
...
interface WirePayloadMap {
  ...
  "platform.model.cleared": PlatformModelClearedPayload;
  "platform.model.selected": PlatformModelSelectedPayload;
