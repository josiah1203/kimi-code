/**
 * SpiderByte Agent Core public surface — re-exports every domain barrel (grouped by
...
export * from '#/app/secrets/platformSecretStore';
export * from '#/app/governance/governance';
export * from '#/app/governance/errors';
import '#/app/governance/governanceService';
export * from '#/app/authorization/authorization';
export * from '#/app/authorization/errors';
import '#/app/authorization/authorizationService';
export * from '#/app/platformPlugins/platformPlugins';
export * from '#/app/platformPlugins/errors';
import '#/app/platformPlugins/platformPluginsService';
...
export * from '#/agent/platformModelBinding/platformModelBinding';
import '#/agent/platformModelBinding/platformModelBindingService';
export * from '#/agent/platformRunReplay/platformRunReplay';
import '#/agent/platformRunReplay/platformRunReplayService';
export * from '#/agent/platformApproval/platformApproval';
import '#/agent/platformApproval/platformApprovalService';
export * from '#/agent/platformConversation/platformConversation';
import '#/agent/platformConversation/platformConversationService';
export * from '#/agent/tools/platform/platformTools';
import '#/agent/tools/platform/platformToolImplementations';
export * from '#/agent/tools/platform/baselineWorkflow';
export * from '#/os/interface/terminal';
export * from '#/os/interface/terminalErrors';
export * from '#/os/backends/node-local/hostTerminalService';
...
import '#/workspace/platformServices/flag';
export * from '#/workspace/platformEvents/platformEvents';
import '#/workspace/platformEvents/platformEventService';
export * from '#/workspace/resources/resource';
import '#/workspace/resources/resourceService';
export * from '#/workspace/artifacts/artifact';
import '#/workspace/artifacts/artifactService';
export * from '#/workspace/executionTargets/executionTarget';
import '#/workspace/executionTargets/executionTargetService';
export * from '#/workspace/execution/execution';
export * from '#/workspace/execution/errors';
export * from '#/workspace/execution/platformWorker';
export * from '#/workspace/execution/sshDaemon';
export * from '#/workspace/execution/sshDaemonProtocol';
export * from '#/workspace/execution/sshDaemonStdio';
import '#/workspace/execution/executionService';
import '#/workspace/execution/sshDaemon';
export * from '#/workspace/automations/automation';
import '#/workspace/automations/automationService';
export * from '#/workspace/usage/usage';
export * from '#/workspace/usage/errors';
import '#/workspace/usage/usageService';
export * from '#/workspace/budgets/budget';
export * from '#/workspace/budgets/errors';
import '#/workspace/budgets/budgetService';
export * from '#/workspace/providerConnections/providerConnection';
export * from '#/workspace/providerConnections/providerRuntime';
export * from '#/workspace/providerConnections/runtimeErrors';
import '#/workspace/providerConnections/providerRuntimeService';
export * from '#/workspace/datasets/dataset';
export * from '#/workspace/datasets/errors';
import '#/workspace/datasets/datasetService';
export * from '#/workspace/ml/ml';
export * from '#/workspace/ml/errors';
import '#/workspace/ml/mlService';
export * from '#/workspace/pipelines/pipeline';
export * from '#/workspace/pipelines/errors';
import '#/workspace/pipelines/pipelineService';
export * from '#/workspace/serving/serving';
export * from '#/workspace/serving/errors';
import '#/workspace/serving/servingService';
export type {
  ExtraBody,
  GenerationKwargs,
  KimiThinkingConfig,
...
export * from '#/app/kosongConfig/providerSecrets';
...
export * from '#/workspace/providerConnections/providerConnection';
export * from '#/workspace/providerConnections/providerConnectionService';
export * from '#/workspace/policy/policy';
export * from '#/workspace/policy/policyService';
...
export * from '#/app/authSummary/authSummary';
export * from '#/app/authSummary/authSummaryService';
...
export * from '#/agent/media/spiderbyteFileUrl';
