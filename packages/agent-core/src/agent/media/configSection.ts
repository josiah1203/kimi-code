 ...
 * operational env override (`SPIDERBYTE_IMAGE_MAX_EDGE_PX` /
 * `SPIDERBYTE_IMAGE_READ_BYTE_BUDGET`); `config` resolves each field as
...
export const IMAGE_MAX_EDGE_ENV = 'SPIDERBYTE_IMAGE_MAX_EDGE_PX';
export const IMAGE_READ_BYTE_BUDGET_ENV = 'SPIDERBYTE_IMAGE_READ_BYTE_BUDGET';
