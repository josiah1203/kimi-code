...
export interface GetSpiderByteConfigPayload {
...
export type SetSpiderByteConfigPayload = ResolvedConfig;
...
export interface CoreAPI extends SessionAPIWithId {
  ...
  getSpiderByteConfig: (payload: GetSpiderByteConfigPayload) => ResolvedConfig;
  getConfigDiagnostics: (payload: EmptyPayload) => ConfigDiagnostics;
  setSpiderByteConfig: (payload: SetSpiderByteConfigPayload) => ResolvedConfig;
