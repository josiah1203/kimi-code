 ...
 * also accept operational env overrides (`SPIDERBYTE_LOOP_MAX_STEPS_PER_TURN` /
 * `SPIDERBYTE_LOOP_MAX_ATTEMPTS_PER_STEP`; the former
 * `SPIDERBYTE_LOOP_MAX_RETRIES_PER_STEP` still resolves as a deprecated fallback
...
export const LOOP_MAX_STEPS_PER_TURN_ENV = 'SPIDERBYTE_LOOP_MAX_STEPS_PER_TURN';
export const LOOP_MAX_ATTEMPTS_PER_STEP_ENV = 'SPIDERBYTE_LOOP_MAX_ATTEMPTS_PER_STEP';
/** Deprecated former name of {@link LOOP_MAX_ATTEMPTS_PER_STEP_ENV}. */
export const LOOP_MAX_RETRIES_PER_STEP_ENV = 'SPIDERBYTE_LOOP_MAX_RETRIES_PER_STEP';
