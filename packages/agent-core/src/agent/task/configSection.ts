 ...
 * accept the v1 env overrides `SPIDERBYTE_BACKGROUND_KEEP_ALIVE_ON_EXIT` /
 * `SPIDERBYTE_BACKGROUND_MAX_RUNNING_TASKS`
 ...
 * `spyderbyte -p` print-mode background policy (`printBackgroundMode` /
...
export const KEEP_ALIVE_ON_EXIT_ENV = 'SPIDERBYTE_BACKGROUND_KEEP_ALIVE_ON_EXIT';
export const MAX_RUNNING_TASKS_ENV = 'SPIDERBYTE_BACKGROUND_MAX_RUNNING_TASKS';
