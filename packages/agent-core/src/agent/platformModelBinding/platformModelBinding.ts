 ...
 * provider/model selection without storing credentials or replacing SpiderByte's
...
import type { ModelRef, PlatformModelSelection as PlatformModelSelectionProjection } from '@spiderbyte/protocol';

export type { ModelRef } from '@spiderbyte/protocol';
