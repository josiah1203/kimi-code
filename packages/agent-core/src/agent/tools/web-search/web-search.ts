 ...
 * receives an optional provider from the App-scope
 * `IWebSearchProviderService` (`auth` domain) at activation time. The default
 * Open Core composition leaves the tool unavailable until a host supplies a
 * provider.
 */
