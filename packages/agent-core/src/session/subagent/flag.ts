 ...
 * enable via `SPIDERBYTE_EXPERIMENTAL_SECONDARY_MODEL`, the master
 * `SPIDERBYTE_EXPERIMENTAL_FLAG`, or the `[experimental]` config section.
 */

import { type FlagDefinitionInput, registerFlagDefinition } from '#/app/flag/flagRegistry';

export const SECONDARY_MODEL_FLAG_ID = 'secondary-model';
export const SECONDARY_MODEL_FLAG_ENV = 'SPIDERBYTE_EXPERIMENTAL_SECONDARY_MODEL';
