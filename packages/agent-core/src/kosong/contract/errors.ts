...
const THINKING_EFFORT_CONFIG_DOCS_URL =
  'https://github.com/SpiderByte/spiderbyte/tree/main/docs/en/configuration/config-files.html#thinking';
...
The provider rejected the configured thinking effort. Other providers receive effort strings without client-side mapping; choose an effort supported by the selected model. For models, check support_efforts and default_effort. See ${THINKING_EFFORT_CONFIG_DOCS_URL}`;
}
