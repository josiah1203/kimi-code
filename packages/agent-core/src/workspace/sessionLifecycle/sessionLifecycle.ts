...
export interface ForkSessionOptions {
  ...
  /**
   * Retain the source conversation through this zero-based user-visible turn.
   * The fork copies the corresponding agent journals before restoring the
   * target scopes, so resumed context and agent metadata see the same cut.
   */
