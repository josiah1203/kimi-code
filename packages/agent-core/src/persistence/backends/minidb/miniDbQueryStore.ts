 ...
 * ordinary `MiniDb` directories, so multiple processes can read and
...
import { type QueryOptions } from '@spiderbyte/minidb';
import { ClusterDb } from '@spiderbyte/minidb/cluster';
