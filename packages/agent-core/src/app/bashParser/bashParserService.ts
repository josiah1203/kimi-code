 ...
 *
 * Thin adapter over the pure `@spiderbyte/tree-sitter-bash` package: runs
...
import { parse } from '@spiderbyte/tree-sitter-bash';
import type { SyntaxNode } from '@spiderbyte/tree-sitter-bash';
