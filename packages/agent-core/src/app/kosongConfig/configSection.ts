...
export const ENV_MODEL_PROVIDER_KEY = '__spiderbyte_env__';
...
export const providersEnvBindings = envBindings(ProvidersSectionSchema, {
  [ENV_MODEL_PROVIDER_KEY]: envBindings(ProviderConfigSchema, {
    apiKey: 'SPIDERBYTE_MODEL_API_KEY',
    type: 'SPIDERBYTE_MODEL_PROVIDER_TYPE',
    baseUrl: 'SPIDERBYTE_MODEL_BASE_URL',
  }),
});
...
export const thinkingEnvBindings = envBindings(ThinkingConfigSchema, {
  forcedEffort: 'SPIDERBYTE_MODEL_THINKING_EFFORT',
});
...
export const SECONDARY_MODEL_ENV = 'SPIDERBYTE_SECONDARY_MODEL';
export const SECONDARY_MODEL_EFFORT_ENV = 'SPIDERBYTE_SECONDARY_EFFORT';
