...
export const telemetryEventDefinitions = {
  ...
  turn_interrupted: defineAgentTelemetryEvent<TurnInterruptedEvent>({
    ...
    properties: {
      ...
      trace_id:
        'Trace id of the most recent LLM request in this turn (the failed request when the turn errored); absent for protocols that do not expose one',
    },
  }),
  turn_ended: defineAgentTelemetryEvent<TurnEndedEvent>({
    ...
    properties: {
      ...
      thinking_effort: 'Effective thinking effort the turn ran with',
      trace_id:
        'Trace id of the most recent LLM request in this turn; absent for protocols that do not expose one',
    },
  }),
  tool_call: defineAgentTelemetryEvent<ToolCallEvent>({
    ...
    properties: {
      ...
      trace_id:
        'Trace id of the LLM request that produced this tool call; absent for protocols that do not expose one',
    },
  }),
  api_error: defineAgentTelemetryEvent<ApiErrorEvent>({
    ...
    properties: {
      ...
      trace_id:
        'Trace id of the failed request, from its response headers or its error response; absent when the failure happened before any response headers arrived (network errors, local aborts), and for protocols that do not expose one',
    },
  }),
  ...
  cancel: defineAgentTelemetryEvent<CancelEvent>({
    ...
    properties: {
      ...
      trace_id:
        'Trace id of the in-flight request, or of the most recent request between steps; absent for protocols that do not expose one',
    },
  }),
  ...
  permission_approval_result: defineAgentTelemetryEvent<PermissionApprovalResultEvent>({
    ...
    properties: {
      ...
      trace_id:
        'Trace id of the LLM request that produced the gated tool call; absent for protocols that do not expose one',
    },
  }),
  ...
  compaction_finished: defineAgentTelemetryEvent<CompactionFinishedEvent>({
    ...
    properties: {
      ...
      trace_id:
        'Trace id of the final compaction request round; absent for protocols that do not expose one',
    },
  }),
  compaction_failed: defineAgentTelemetryEvent<CompactionFailedEvent>({
    ...
    properties: {
      ...
      trace_id:
        'Trace id of the failed compaction request, from its response headers or its error response; absent when the failure happened before any request or before response headers arrived (network errors), and for protocols that do not expose one',
    },
  }),
  ...
  question_dismissed: defineAgentTelemetryEvent<QuestionDismissedEvent>({
    ...
    properties: {
      trace_id:
        'Trace id of the LLM request that produced the questioning tool call; absent for protocols that do not expose one',
    },
  }),
  ...
  tool_call_dedup_detected: defineAgentTelemetryEvent<ToolCallDedupDetectedEvent>({
    ...
    properties: {
      ...
      trace_id:
        'Trace id of the LLM request that produced the duplicate tool call; absent for protocols that do not expose one',
    },
  }),
  tool_call_repeat: defineAgentTelemetryEvent<ToolCallRepeatEvent>({
    ...
    properties: {
      ...
      trace_id:
        'Trace id of the LLM request that produced the repeated tool call; absent for protocols that do not expose one',
    },
  }),
  agents_md_reminder_shown: defineAgentTelemetryEvent<AgentsMdReminderShownEvent>({
    ...
    properties: {
      ...
      trace_id:
        'Trace id of the LLM request that produced the tool call; absent for protocols that do not expose one',
    },
  }),
