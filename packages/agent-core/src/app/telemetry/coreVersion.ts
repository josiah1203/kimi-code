/**
 * `telemetry` domain — SpiderByte Agent Core package version resolution.
 *
 ...
 * `@spiderbyte/agent-core`. Works whenever the package runs from its own
...
const PACKAGE_NAME = '@spiderbyte/agent-core';
