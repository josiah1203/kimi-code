 ...
 * Both bind to `SPIDERBYTE_IDENTITY_NAME` / `SPIDERBYTE_IDENTITY_SLUG` so a
...
export const IDENTITY_NAME_ENV = 'SPIDERBYTE_IDENTITY_NAME';
export const IDENTITY_SLUG_ENV = 'SPIDERBYTE_IDENTITY_SLUG';
