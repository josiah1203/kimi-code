 ...
 * Run: `pnpm --filter @spiderbyte/agent-core exec vitest run
...
describe('AgentLifecycleService', () => {
  ...
  beforeEach(() => {
    ...
    ix.stub(ISessionContext, {
      ...
      sessionId: 'sess_test',
      workspaceId: 'ws_test',
      sessionDir: '/tmp/spiderbyte-agentLifecycle-test',
      metaScope: 'test',
      scope: (subKey?: string) =>
    ...
    ix.stub(IBootstrapService, {
      _serviceBrand: undefined,
      homeDir: '/tmp/spiderbyte-agentLifecycle-home',
      cwd: '/tmp/spiderbyte-agentLifecycle-home',
    } as unknown as IBootstrapService);
    ix.stub(ISessionWorkspaceContext, {
      _serviceBrand: undefined,
      workDir: '/tmp/spiderbyte-agentLifecycle-work',
      additionalDirs: [],
    ...
    ix.stub(ISessionMetadata, {
      ...
      read: () =>
        Promise.resolve({
          ...
          archived: false,
          agents: {
            'agent-0': { homedir: '/tmp/spiderbyte-agentLifecycle-test/agents/agent-0', type: 'sub' },
            'agent-1': { homedir: '/tmp/spiderbyte-agentLifecycle-test/agents/agent-1', type: 'sub' },
          },
        }),
      update: () => Promise.resolve(),
      setTitle: () => Promise.resolve(),
  ...
  it('persists complete agent metadata when creating a child', async () => {
    ...
    expect(registerAgent).toHaveBeenCalledWith('child', {
      homedir: '/tmp/spiderbyte-agentLifecycle-home/sessions/ws_test/sess_test/agents/child',
      type: 'sub',
      parentAgentId: 'main',
      forkedFrom: 'main',
      labels: { swarmItem: 'swarm-item-1' },
