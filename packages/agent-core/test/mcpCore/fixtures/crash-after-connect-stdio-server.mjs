...
const exitCode = Number.parseInt(process.env['SPIDERBYTE_TEST_MCP_EXIT_CODE'] ?? '1', 10);
const stderrBanner = process.env['SPIDERBYTE_TEST_MCP_STDERR'];
...
const exitAfterMsRaw = process.env['SPIDERBYTE_TEST_MCP_EXIT_AFTER_MS'];
