...
/** Builds a spiderbyte model alias from a normalized catalog model. */
 ...
 * `__SPIDERBYTE_BUILT_IN_CATALOG__` constant injected by tsdown at build
...
export function applyCatalogProvider(
  ...
  Object.assign(config, {
    models,
    defaultModel,
    thinking: { ...config.thinking, enabled: options.thinking },
  });
  return { defaultModel };
}
