import type { GlobalFacade, GlobalPlatformFacade } from '@spiderbyte/client';
 ...
 */
export type SpiderBytePlatformClient = GlobalPlatformFacade;

/** Return the canonical klient facade without introducing an SDK-local authority. */
export function createSpiderBytePlatformClient(global: GlobalFacade): SpiderBytePlatformClient {
...
export {
  ...
  executionTargetAuthenticationMethodSchema,
  executionTargetHealthStatusSchema,
  executionTargetPolicySchema,
  executionTargetResourceInfoSchema,
  ...
  executionTargetVersionCompatibilitySchema,
  platformActorSchema,
...
export type {
  ...
  ExecutionTargetAuthenticationMethod,
  ExecutionTargetHealthStatus,
  ExecutionTargetPolicy,
  ExecutionTargetResourceInfo,
  ...
  ExecutionTargetVersionCompatibility,
  PlatformActor,
