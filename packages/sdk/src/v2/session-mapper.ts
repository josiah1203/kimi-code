/**
 * Pure mapping between the SpiderByte Agent Core session shapes and the v1 SDK wire
 ...
 */
import type { AgentMeta, SessionMeta } from '@spiderbyte/agent-core';
import type {
 ...
 * the SDK test config aliases `@spiderbyte/agent-core` to its index, which
