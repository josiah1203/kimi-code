 ...
 *
 * One wiring instance per live session scope, created by `SpiderByteSdkClient`
...
import type { Event, ToolCallRequest, ToolCallResponse } from '#/events';
import {
...
/**
 * The v2 approval payload (`SpiderByte Agent Core/src/session/approval/approval.ts` —
...
/** The v2 question payload (`SpiderByte Agent Core/src/session/question/question.ts`). */
...
/** The v2 user-tool execution payload (`SpiderByte Agent Core/src/agent/userTool/userToolService.ts`). */
 ...
 * in SpiderByte Agent Core), and the model slice rides only the bind-time emission —
