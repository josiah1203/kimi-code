...
const workspacePackages = new Map([
  ['@spiderbyte/agent-core', 'agent-core'],
  ['@spiderbyte/client', 'client'],
  ['@spiderbyte/kaos', 'kaos'],
  ['@spiderbyte/oauth', 'oauth'],
  ['@spiderbyte/kosong', 'kosong'],
  ['@spiderbyte/protocol', 'protocol'],
]);
  ...
  await Promise.all(
    files.map(async (file) => {
      ...
      const updated = providerClientText.replaceAll(
        /(["'])(#\/[^"']+|@spiderbyte\/(?:agent-core|client|kaos|oauth|kosong|protocol)(?:\/[^"']+)?)\1/g,
