 ...
 * is reachable at `SPIDERBYTE_SERVER_URL`.
 */
...
const TERMINAL_SHELL = process.env['SPIDERBYTE_SERVER_E2E_TERMINAL_SHELL'] ?? '/bin/sh';
const OUTPUT_TIMEOUT_MS = 20_000;
const EXIT_TIMEOUT_MS = 5_000;
const CANARY = `SPIDERBYTE_KLIENT_E2E_TERMINAL_${process.pid}_${Date.now()}`;
