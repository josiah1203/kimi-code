 ...
 */
export declare const PRINT_WAIT_CEILING_S_DEFAULT = 315360000;
/** Cap on extra turns steered by background-task completions: ≈ unbounded. */
export declare const PRINT_MAX_TURNS_DEFAULT = 100000;
/**
 ...
 * stop one.
 */
export declare const PRINT_SUBAGENT_TIMEOUT_MS_DEFAULT = 0;
/**
 ...
 */
export declare const PRINT_BASH_TASK_TIMEOUT_S_DEFAULT = 0;
/**
 ...
 */
export declare function applyPrintModeConfigDefaults(config: KimiConfig): KimiConfig;
