import type { ContentPart, Message } from '@spiderbyte/kosong';
...
export declare const USER_PROMPT_ORIGIN: UserPromptOrigin;
...
export type PromptOrigin = UserPromptOrigin | SkillActivationOrigin | PluginCommandOrigin | InjectionOrigin | ShellCommandOrigin | CompactionSummaryOrigin | SystemTriggerOrigin | BackgroundTaskOrigin | CronJobOrigin | CronMissedOrigin | HookResultOrigin | RetryOrigin;
