import type { ContentPart, ThinkingEffort, TokenUsage } from '@spiderbyte/kosong';
...
export type AgentRecordOf<K extends keyof AgentRecordEvents> = Extract<AgentRecord, {
    readonly type: K;
}>;
