...
export type BackgroundTaskStatus = 'running' | 'completed' | 'failed' | 'timed_out' | 'killed' | 'lost';
export declare const TERMINAL_STATUSES: ReadonlySet<BackgroundTaskStatus>;
...
export type BackgroundTaskInfo = ProcessBackgroundTaskInfo | AgentBackgroundTaskInfo | QuestionBackgroundTaskInfo;
