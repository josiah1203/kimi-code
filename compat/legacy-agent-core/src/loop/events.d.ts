import type { FinishReason, TextPart, ThinkPart, TokenUsage } from '@spiderbyte/kosong';
...
export type LoopRecordedEvent = LoopStepBeginEvent | LoopStepEndEvent | LoopContentPartEvent | LoopToolCallEvent | LoopToolResultEvent;
export type LoopLiveOnlyEvent = LoopTurnInterruptedEvent | LoopStepRetryingEvent | LoopTextDeltaEvent | LoopThinkingDeltaEvent | LoopToolCallDeltaEvent | LoopToolProgressEvent;
...
export declare function createLoopEventDispatcher(input: CreateLoopEventDispatcherInput): LoopEventDispatcher;
