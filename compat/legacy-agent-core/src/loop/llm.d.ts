 ...
 * surfaces.
 */
import type { FinishReason, Message, ModelCapability, TextPart, ThinkPart, TokenUsage, Tool, ToolCall } from '@spiderbyte/kosong';
...
export declare class LLMRequestTraceState implements LLMRequestTrace {
