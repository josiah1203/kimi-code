 ...
 */
import type { ContentPart, Message, TokenUsage, Tool, ToolCall } from '@spiderbyte/kosong';
 ...
 */
export type LoopStepStopReason = 'end_turn' | 'max_tokens' | 'tool_use' | 'filtered' | 'paused' | 'unknown';
...
export type PrepareToolExecutionHook = (ctx: ToolExecutionHookContext) => Promise<PrepareToolExecutionResult | undefined>;
export type AuthorizeToolExecutionHook = (ctx: ResolvedToolExecutionHookContext) => Promise<AuthorizeToolExecutionResult | undefined>;
export type FinalizeToolResultHook = (ctx: FinalizeToolResultContext) => Promise<ExecutableToolResult | undefined>;
export type ShouldContinueAfterStopHook = (ctx: LoopStoppedStepContext) => Promise<ShouldContinueAfterStopResult | undefined>;
/**
