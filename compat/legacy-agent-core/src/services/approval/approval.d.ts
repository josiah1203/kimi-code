...
import type { ApprovalRequest as ProtocolApprovalRequest, ApprovalResponse as ProtocolApprovalResponse } from '@spiderbyte/protocol';
...
export declare const IApprovalService: import("../..").ServiceIdentifier<IApprovalService>;
 ...
 */
export declare function toBrokerRequest(req: ApprovalRequest, params: ToBrokerRequestParams): ProtocolApprovalRequest;
/**
 * Protocol REST request body → in-process SDK response.
 *
 * Used by the REST resolve handler to settle the agent-side Promise.
 */
export declare function toAgentCoreResponse(resp: ProtocolApprovalResponse): ApprovalResponse;
