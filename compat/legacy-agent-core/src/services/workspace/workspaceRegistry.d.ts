...
export declare class WorkspaceRootNotFoundError extends Error {
...
export declare const IWorkspaceRegistry: import("../..").ServiceIdentifier<IWorkspaceRegistry>;
export declare abstract class WorkspaceRegistryBase extends Disposable implements IWorkspaceRegistry {
    readonly _serviceBrand: undefined;
