...
export declare function toProtocolSkill(info: AgentCoreSkillSummary): SkillDescriptor;
...
export declare const ISkillService: import("../..").ServiceIdentifier<ISkillService>;
/**
 ...
 */
export declare class SkillNotActivatableError extends Error {
    readonly skillName: string;
    constructor(skillName: string, message?: string);
}
