 ...
 *
 * - `Event` (from `@spiderbyte/legacy-agent-core/base/common/event`) — the generic
 *   VSCode-style emitter accessor type. `Event<T>` is the listener-tuple
 *   type used to declare `readonly onDidXxx: Event<T>`.
 * - `ProtocolEvent` (alias of `@spiderbyte/protocol`'s `Event`) — the
...
export declare const IEventService: import("../..").ServiceIdentifier<IEventService>;
