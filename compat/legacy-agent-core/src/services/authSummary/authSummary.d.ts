...
export declare const IAuthSummaryService: import("../..").ServiceIdentifier<IAuthSummaryService>;
/**
 * `40110 auth.provisioning_required` — daemon has zero provider configs.
 */
export declare class AuthProvisioningRequiredError extends Error {
    constructor();
}
/**
 ...
 */
export declare class AuthTokenUnauthorizedError extends Error {
    readonly providerId: string;
    constructor(providerId: string);
}
/**
 ...
 */
export declare class AuthModelNotResolvedError extends Error {
