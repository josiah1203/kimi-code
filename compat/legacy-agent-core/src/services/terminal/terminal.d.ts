...
import type { CreateTerminalRequest, Terminal, TerminalExitMessage, TerminalOutputMessage } from '@spiderbyte/protocol';
...
export declare const ITerminalService: import("../..").ServiceIdentifier<ITerminalService>;
export declare class TerminalNotFoundError extends Error {
    readonly sessionId: string;
    readonly terminalId: string;
    constructor(sessionId: string, terminalId: string);
}
export declare function disposeAll(items: Iterable<IDisposable>): void;
