 ...
 * store.
 *
 * **Anti-corruption**: imports `@spiderbyte/legacy-agent-core` only for type-only
...
import type { PromptListResponse, PromptSubmission, PromptStatus, PromptSteerResult, PromptSubmitResult } from '@spiderbyte/protocol';
...
export declare const IPromptService: import("../..").ServiceIdentifier<IPromptService>;
/**
 ...
 */
export declare class PromptAlreadyCompletedError extends Error {
    readonly sessionId: string;
    readonly promptId: string;
    constructor(sessionId: string, promptId: string);
}
...
export interface PromptDispatchLogEntry {
    ...
    readonly ts: string;
    /** Which setter ran. */
    readonly kind: 'setModel' | 'setThinking' | 'setPermission' | 'enterPlan' | 'cancelPlan' | 'enterSwarm' | 'exitSwarm' | 'createGoal' | 'pauseGoal' | 'resumeGoal' | 'cancelGoal';
