...
import type { GoalBudgetLimits, GoalBudgetReport, GoalChange, GoalChangeStats, GoalSnapshot, GoalStatus, GoalToolResult } from '#/agent/goal';
...
export type TextPromptPart = Extract<ContentPart, {
    type: 'text';
}>;
export type PromptPart = Extract<ContentPart, {
...
export type { GoalBudgetLimits, GoalBudgetReport, GoalChange, GoalChangeStats, GoalSnapshot, GoalStatus, GoalToolResult, };
...
export interface CoreAPI extends SessionAPIWithId {
    applyPersistedSecondaryModel: (payload: EmptyPayload & {
        readonly sessionId: string;
    }) => void;
    ...
    listGlobalMcpServerAuthStatuses: (payload: EmptyPayload) => readonly GlobalMcpServerAuthStatus[];
