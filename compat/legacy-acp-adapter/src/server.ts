...
import { LocalKaos, type Kaos } from '@spiderbyte/kaos';
...
export class AcpServer implements Agent {
  ...
  async newSession(params: NewSessionRequest): Promise<NewSessionResponse> {
    ...
    // `packages/sdk/src/spiderbyte-harness.ts:createSession` and
    // `packages/sdk/src/rpc.ts:createSession`), so the kernel
