 ...
 *
 * Used to live inside `@spiderbyte/sdk` as
...
import { effectiveModelAlias, type ProviderType } from '@spiderbyte/legacy-agent-core';
import type { KimiHarness, ModelAlias } from '@spiderbyte/sdk';
