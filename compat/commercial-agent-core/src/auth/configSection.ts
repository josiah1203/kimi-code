 ...
 * (`SPIDERBYTE_WEB_SEARCH_*` / `SPIDERBYTE_WEB_FETCH_*`, env wins over the file). Its
...
export const WEB_SEARCH_BASE_URL_ENV = 'SPIDERBYTE_WEB_SEARCH_BASE_URL';
export const WEB_SEARCH_API_KEY_ENV = 'SPIDERBYTE_WEB_SEARCH_API_KEY';
export const WEB_FETCH_BASE_URL_ENV = 'SPIDERBYTE_WEB_FETCH_BASE_URL';
export const WEB_FETCH_API_KEY_ENV = 'SPIDERBYTE_WEB_FETCH_API_KEY';
