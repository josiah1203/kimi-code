<!--
Thank you for your contribution to SpiderByte!
Please open an issue before sending a feature PR — PRs without prior discussion may be closed without review.

See https://github.com/MoonshotAI/spiderbyte/blob/main/CONTRIBUTING.md for more.
-->
...
<!-- What did you implement, and why does this approach fit SpiderByte? -->

## Checklist

- [ ] I have read the [CONTRIBUTING](https://github.com/MoonshotAI/spiderbyte/blob/main/CONTRIBUTING.md) document.
