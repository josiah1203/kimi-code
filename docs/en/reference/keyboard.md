...
| `Ctrl-D` | Exit SpiderByte CLI when the input box is empty |
...
- [`spyderbyte` Command](./spyderbyte-command.md) — Complete reference for startup flags and subcommands
