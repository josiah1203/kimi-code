 ...
 * (`/api/v2/ws`).
 *
 * The proxies are typed by the real `SpiderByte Agent Core` contracts at the call
...
import { IAgentGoalService } from '@spiderbyte/agent-core/agent/goal/goal';
import { IAgentMcpService } from '@spiderbyte/agent-core/agent/mcp/mcp';
import { IAgentPermissionModeService } from '@spiderbyte/agent-core/agent/permissionMode/permissionMode';
import { IAgentPermissionRulesService } from '@spiderbyte/agent-core/agent/permissionRules/permissionRules';
...
import { IAgentSwarmService } from '@spiderbyte/agent-core/agent/swarm/swarm';
import { IAgentTaskService } from '@spiderbyte/agent-core/agent/task/task';
import { IAgentTokenCountingService } from '@spiderbyte/agent-core/agent/tokenCounting/tokenCounting';
import { IAgentToolRegistryService } from '@spiderbyte/agent-core/agent/toolRegistry/toolRegistry';
import { IAgentUsageService } from '@spiderbyte/agent-core/agent/usage/usage';
import { IAuthSummaryService } from '@spiderbyte/agent-core/app/auth/auth';
...
import { ISessionInitService } from '@spiderbyte/agent-core/session/sessionInit/sessionInit';
import { ISessionMetadata } from '@spiderbyte/agent-core/session/sessionMetadata/sessionMetadata';
import { ISessionWorkspaceContext } from '@spiderbyte/agent-core/session/workspaceContext/workspaceContext';
