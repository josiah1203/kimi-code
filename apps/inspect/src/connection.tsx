...
export interface ConnectOptions {
  ...
  /** Remember just this URL as the preferred discovery pick (`spiderbyte-inspect.server-url`). */
  readonly rememberServerUrl?: string;
}

const STORAGE_KEY = 'spiderbyte-inspect.connection';
const REMEMBERED_SERVER_KEY = 'spiderbyte-inspect.server-url';
    ...
    <div className="flex h-screen items-center justify-center">
      <div className="w-[520px] rounded-lg border border-red-900/60 bg-neutral-900 p-6 shadow-xl">
        ...
        <p className="mb-3 text-xs leading-relaxed text-neutral-400">
          SpiderByte Inspect talks to kap-server exclusively over the debug RPC surface (
...
function ConnectScreen({
  ...
  return (
    <div className="flex h-screen items-center justify-center">
      ...
      >
        <h1 className="mb-1 text-lg font-semibold text-neutral-100">SpiderByte Inspect</h1>
        <p className="mb-5 text-xs text-neutral-500">
          ...
          {` (${__SPIDERBYTE_INSPECT_PROXY_TARGET__})`}.
        </p>
        {servers.length > 0 ? (
          <div className="mb-5">
        ...
        <input
          ...
          placeholder="~/.spiderbyte/server.token"
          value={token}
...
declare const __SPIDERBYTE_INSPECT_PROXY_TARGET__: string;
