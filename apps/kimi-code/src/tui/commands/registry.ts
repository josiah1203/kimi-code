...
const PROVIDER_ARG_COMPLETIONS: readonly ArgCompletionSpec[] = [
  ...
  { value: 'legacy', description: 'Open the legacy config.toml provider adapter' },
];
...
export const BUILTIN_SLASH_COMMANDS = [
  ...
  },
  {
    name: 'provider',
    aliases: ['providers'],
    description: 'Manage canonical providers and governed BYOK connections',
    priority: 95,
    availability: 'always',
    argumentHint: '[platform|legacy]',
  ...
  },
  {
    ...
    priority: 85,
    argumentHint: '[members|entitlements]',
    availability: 'always',
  },
  {
    name: 'project',
  ...
  },
  {
    name: 'feedback',
    aliases: ['bug'],
    description: 'Send feedback to make SpiderByte better',
    priority: 60,
    availability: 'always',
  },
  {
