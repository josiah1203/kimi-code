...
// `spiderbyte.plugin.json` is authoritative once it exists, and `.spiderbyte-plugin/plugin.json`
...
export async function readPluginManifestVersion(pluginDir) {
  for (const rel of ['spiderbyte.plugin.json', '.spiderbyte-plugin/plugin.json']) {
