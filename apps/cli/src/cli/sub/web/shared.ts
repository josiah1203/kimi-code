/**
 * Shared helpers for `spyderbyte web` and its subcommands.
 *
...
import type { ServerLogLevel } from '@spiderbyte/kap-server';
...
/** Filename (under SPIDERBYTE_HOME) of the persistent server bearer token. */
 ...
 * is the CLI's own SPIDERBYTE_HOME resolution (`getDataDir()`).
 *
