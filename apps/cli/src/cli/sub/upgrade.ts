...
import { track as trackTelemetry, type TelemetryProperties } from '@spiderbyte/telemetry';
...
export async function handleUpgrade(
  ...
  if (target === null) {
    ...
    deps.stdout.write(`SpiderByte is already up to date (${formatDisplayVersion(currentVersion)}).\n`);
    return 0;
  }
