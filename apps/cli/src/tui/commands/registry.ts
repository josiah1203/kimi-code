...
import type { AutocompleteItem } from '@spiderbyte/pi-tui';

import { completeLeadingArg, type ArgCompletionSpec } from './complete-args';
import type { SpiderByteSlashCommand, SlashCommandAvailability } from './types';
...
export const BUILTIN_SLASH_COMMANDS = [
  ...
  },
  {
    name: 'workspace',
    aliases: ['workspaces'],
    description: 'Inspect the current Business workspace and members',
    priority: 85,
    argumentHint: '[members]',
    availability: 'always',
  },
  {
    name: 'project',
    aliases: ['projects'],
    description: 'Inspect the Project bound to the current workspace',
    priority: 85,
    availability: 'always',
  },
  {
    name: 'organization',
    aliases: ['organizations', 'org'],
    description: 'Inspect SpiderByte organizations',
    priority: 85,
    availability: 'always',
  },
  {
    name: 'members',
    aliases: ['member'],
    description: 'Inspect organization, Project, and workspace members',
    priority: 85,
    availability: 'always',
  },
  {
    name: 'connections',
    aliases: ['connection'],
    description: 'Inspect governed provider connections',
    priority: 85,
    availability: 'always',
  },
  {
    name: 'budgets',
    aliases: ['budget'],
    description: 'Inspect budget reservations and threshold warnings',
    priority: 85,
    availability: 'always',
  },
  {
    name: 'policy',
    aliases: ['policies'],
    description: 'Inspect policy rules and pending approval decisions',
    priority: 85,
    argumentHint: '[rules|decisions]',
    availability: 'always',
  },
  {
    name: 'targets',
    aliases: ['execution-targets'],
    description: 'Inspect local and customer-managed execution targets',
    priority: 80,
    availability: 'always',
  },
  {
    name: 'artifacts',
    aliases: ['artifact'],
    description: 'Inspect durable artifacts and their content-addressed records',
    priority: 80,
    argumentHint: '[kind]',
    availability: 'always',
  },
  {
    name: 'datasets',
    aliases: ['dataset'],
    description: 'Inspect registered datasets and versions',
    priority: 80,
    argumentHint: '[dataset-id]',
    availability: 'always',
  },
  {
    name: 'ml',
    aliases: ['experiment', 'ml-experiments'],
    description: 'Inspect native ML experiments and training runs',
    priority: 80,
    argumentHint: '[experiment-id]',
    availability: 'always',
  },
  {
    name: 'models',
    aliases: ['registered-models'],
    description: 'Inspect registered model versions and metrics',
    priority: 80,
  ...
  },
  {
    name: 'pipelines',
    aliases: ['pipeline'],
    description: 'Inspect durable pipelines and pipeline Runs',
    priority: 80,
  ...
  },
  {
    name: 'automations',
    aliases: ['automation'],
    description: 'Inspect governed automations and schedules',
    priority: 80,
    argumentHint: '[automation-id]',
    availability: 'always',
  },
  {
    name: 'approvals',
    aliases: ['approval'],
    description: 'Inspect pending platform approvals',
    priority: 80,
    availability: 'always',
  },
  {
  ...
  },
  {
    name: 'connect',
    aliases: [],
    description: 'Configure a local or BYOK provider',
    priority: 40,
  },
  {
    name: 'disconnect',
...
] as const satisfies readonly SpiderByteSlashCommand[];
...
export function findBuiltInSlashCommand(commandName: string): BuiltinSlashCommand | undefined {
  const commands = BUILTIN_SLASH_COMMANDS as readonly SpiderByteSlashCommand<BuiltinSlashCommandName>[];
...
export function resolveSlashCommandAvailability(
  command: SpiderByteSlashCommand,
  args: string,
...
export function sortSlashCommands(commands: readonly SpiderByteSlashCommand[]): SpiderByteSlashCommand[] {
