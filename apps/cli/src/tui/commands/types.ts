import type { AutocompleteItem, SlashCommand } from '@spiderbyte/pi-tui';
import type { FlagId } from '@spiderbyte/sdk';

export type SlashCommandAvailability = 'always' | 'idle-only';

export interface SpiderByteSlashCommand<Name extends string = string> extends SlashCommand {
  readonly name: Name;
