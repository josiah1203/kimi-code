 ...
 * spiderbyte client preferences such as terminal UI and update behavior.
 */
...
# command = "~/.spiderbyte/statusline.sh"
`;
  return `# ~/.spiderbyte/tui.toml
# Client preferences for spiderbyte.
# Agent/runtime settings stay in ~/.spiderbyte/config.toml.
