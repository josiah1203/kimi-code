...
export const WORKING_TIPS: readonly ToolbarTip[] = [
  ...
  {
    text: '/plugins: manage local plugins and MCP integrations for additional data sources',
    solo: true,
    priority: 3,
  },
  { text: 'ask SpiderByte to schedule tasks, e.g. "remind me at 5pm"', solo: true, priority: 3 },
...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: '/auto when you want SpiderByte to handle approvals and keep going unattended' },
  ...
  { text: 'shift-tab to Plan mode to review the approach before SpiderByte edits files.', priority: 2 },
