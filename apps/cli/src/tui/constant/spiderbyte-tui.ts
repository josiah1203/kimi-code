export { PROVIDER_CONFIGURATION_REQUIRED_CODE, PRODUCT_NAME } from '#/constant/app';

export const LLM_NOT_SET_MESSAGE = 'No model configured. Use /connect or /provider to configure one.';
export const NO_ACTIVE_SESSION_MESSAGE = 'No active session. Configure a local or BYOK provider first.';
export const CTRL_D_HINT = 'Press Ctrl+D again to exit';
export const CTRL_C_HINT = 'Press Ctrl+C again to exit';
export const MAIN_AGENT_ID = 'main';
export const PROVIDER_CONFIGURATION_REQUIRED_NOTICE = 'The configured provider is not ready. Use /connect or /provider to update it.';
