 ...
 *
 * Run:
 *   pnpm --filter @spiderbyte/cli exec vitest bench test/tui/tui-frame.bench.ts
 */

import type { Component, Terminal } from '@spiderbyte/pi-tui';
import { TUI } from '@spiderbyte/pi-tui';
