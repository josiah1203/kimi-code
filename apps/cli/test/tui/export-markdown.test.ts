...
import type { ContentPart, ToolCall } from '@spiderbyte/sdk';
import type { ContextMessage } from '@spiderbyte/sdk';
import type { PromptOrigin } from '@spiderbyte/agent-core';
...
describe('buildExportMarkdown', () => {
  ...
  it('builds complete markdown with frontmatter and overview', () => {
    ...
    expect(md).toContain('# SpiderByte Session Export');
