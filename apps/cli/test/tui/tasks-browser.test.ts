import type { Terminal } from '@spiderbyte/pi-tui';
import type { BackgroundTaskInfo, BackgroundTaskStatus } from '@spiderbyte/sdk';
...
describe('TasksBrowserApp — full-screen rendering', () => {
  ...
  it('shows the bound model and effort for agent tasks in the Detail pane', () => {
    ...
    expect(out).toContain('spiderbyte/k3-256k');
