...
describe('FooterComponent', () => {
  ...
  it('paints the model name in rainbow while colored', () => {
    ...
    // "spiderbyte-k2" spreads across the palette, pulling in colors the footer
  ...
  it('shows the effort for an effort-capable model', () => {
    ...
    const state: AppState = {
      ...appState,
      thinkingEffort: 'max',
      availableModels: { 'spiderbyte-k2': effortModel },
    };
  ...
  it('does not show the effort for a legacy boolean model', () => {
    ...
    const state: AppState = {
      ...appState,
      thinkingEffort: 'high',
      availableModels: { 'spiderbyte-k2': plainModel },
    };
    const footer = new FooterComponent(state);
...
describe('FooterComponent overrides', () => {
  it('shows the overridden effort list', () => {
    ...
    const state: AppState = {
      ...appState,
      thinkingEffort: 'high',
      availableModels: { 'spiderbyte-k2': effortModelWithOverride },
    };
    const footer = new FooterComponent(state);
