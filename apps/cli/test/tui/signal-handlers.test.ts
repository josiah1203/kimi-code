...
function makeDriver(): { driver: SignalDriver; tui: SpiderByteTUI } {
  const tui = new SpiderByteTUI(makeHarness() as never, makeStartupInput());
...
describe('SpiderByteTUI signal handlers', () => {
