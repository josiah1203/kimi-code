...
import type { SpiderByteHarness } from "@spiderbyte/sdk";
 ...
 */
export class SpiderByteWebviewProvider implements vscode.WebviewViewProvider {
  ...
  createPanel(): vscode.WebviewPanel {
    ...
    const panel = vscode.window.createWebviewPanel("spiderbytePanel", "SpiderByte", vscode.ViewColumn.One, {
      enableScripts: true,
