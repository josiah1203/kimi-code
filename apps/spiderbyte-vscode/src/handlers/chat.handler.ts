...
import { isSpiderByteError } from "@spiderbyte/sdk";

import { Events, Methods } from "../../shared/bridge";
import type { ApprovalResponse, ContentPart } from "../../shared/spiderbyte-sdk-types";
import { getUserMessage } from "../../shared/errors";
import type { ErrorPhase } from "../../shared/types";
import { VSCodeSettings } from "../config/vscode-settings";
import { normalizeEffort } from "../runtime/spiderbyte-runtime";
...
const streamChat: Handler<StreamChatParams, { done: boolean }> = async (params, ctx) => {
  if (!ctx.workDir) {
    ...
    void vscode.window.showWarningMessage("SpiderByte: Please open a folder first.", "Open Folder").then((action) => {
