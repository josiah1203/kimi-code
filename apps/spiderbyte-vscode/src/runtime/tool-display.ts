import type { ToolInputDisplay } from "@spiderbyte/sdk";

import type { DisplayBlock } from "../../shared/spiderbyte-sdk-types";
...
export function toCompatibilityDisplay(display: ToolInputDisplay): DisplayBlock[] {
  switch (display.kind) {
    case "command":
