...
import type { ApprovalResponse, QuestionRequest as CompatibilityQuestionRequest } from "../../shared/spiderbyte-sdk-types";
import { describeToolDisplay, toCompatibilityDisplay } from "./tool-display";

export type ReverseRpcEvent =
  | { type: "ApprovalRequest"; payload: ReturnType<typeof approvalPayload> }
  | { type: "QuestionRequest"; payload: CompatibilityQuestionRequest };
...
function approvalPayload(id: string, request: ApprovalRequest) {
  return {
    ...
    display: toCompatibilityDisplay(request.display),
  };
}
