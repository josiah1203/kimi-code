/**
 * UI-facing protocol types shared by the extension host and Webview.
 *
 * The extension host adapts SpiderByte Agent Core events into this shape; the
 * file contains data contracts only and no engine runtime.
 */
...
export type CompatibilityWireEvent =
