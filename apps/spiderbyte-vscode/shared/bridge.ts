...
export const Methods = {
  ...
  GetSpiderByteSessions: "getSpiderByteSessions",
  GetAllSpiderByteSessions: "getAllSpiderByteSessions",
  GetRegisteredWorkDirs: "getRegisteredWorkDirs",
  SetWorkDir: "setWorkDir",
  BrowseWorkDir: "browseWorkDir",
  LoadSpiderByteSessionHistory: "loadSpiderByteSessionHistory",
  DeleteSpiderByteSession: "deleteSpiderByteSession",
  ForkSpiderByteSession: "forkSpiderByteSession",
...
function validateParams(method: RpcMethod, params: unknown): boolean {
  switch (method) {
    ...
    case Methods.GetSpiderByteSessions:
    case Methods.GetAllSpiderByteSessions:
    ...
    case Methods.LoadSpiderByteSessionHistory:
      return hasNonEmptyString(params, "spiderbyteSessionId");
    case Methods.DeleteSpiderByteSession:
      return hasNonEmptyString(params, "sessionId");
    case Methods.ForkSpiderByteSession:
      return isPlainObject(params)
