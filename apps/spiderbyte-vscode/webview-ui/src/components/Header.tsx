...
import { SpiderByteLogo } from "./SpiderByteLogo";
  ...
  return (
    <header className="flex items-center justify-between px-3 py-2 border-b border-border shrink-0 @container">
      <div className="flex items-center gap-2 shrink-0">
        <SpiderByteLogo className="size-5 shrink-0" />
        <span className="text-sm font-semibold whitespace-nowrap">SpiderByte</span>
      </div>
