...
import type { ContentPart } from "shared/spiderbyte-sdk-types";
    ...
    <div className="@container px-3 py-3 group/message">
      <div className="flex gap-3 flex-col">
        <div className="flex flex-row items-center justify-start gap-2">
          ...
          <div className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">SpiderByte</div>
        </div>
